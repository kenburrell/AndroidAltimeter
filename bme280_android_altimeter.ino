 ...
 *   
 *   This utilizes a Serial connection from the Arduino Leonardo to the Android via an OTG
 *   cable, requiring the VectorDisplay app (Omega Centauri Software) from the PlayStore,
 ...
 *   
 *  I2C communication with BME280 on an Arduino Leonardo 5V/16MHz.
 *  
